SYSTEM_ENTITY_RELATIONSHIP_EXTRACTION_PROMPT_1 = """
# Role
...
HUMAN_ENTITY_RELATIONSHIP_EXTRACTION_PROMPT_1 = """
Analiza el siguiente texto de entrada y extrae las entidades y relaciones siguiendo estrictamente los pasos a continuación.

# Steps

### 1. Extracción de Entidades
Identifica todos los sustantivos clave.
...
- **Campos requeridos**:
    ...
    - `entity_type`: Categoría (PERSONA, ORGANIZACION, EVENTO, LUGAR, CONCEPTO, etc.).
